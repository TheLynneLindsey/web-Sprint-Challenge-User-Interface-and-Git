...
Desciptive features in the code 

2. Name two big differences between ```display: block;``` and ```display: inline;```.

on the same line and the other is blocked together on top of one another 
...
aligning all items to the center of the page 

5. Explain why git is valuable to a team of developers.

valuable to assist with getting code to run in other programs to put the code in place for the sites 
